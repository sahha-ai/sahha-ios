extension SahhaSensor {
    var biomarkerCategory: SahhaBiomarkerCategory {
        ...
        case .sleep:
            .sleep
        case .steps, .floors_climbed, .move_time, .stand_time, .exercise_time, .activity_summary, .active_energy_burned, .basal_energy_burned,
            .total_energy_burned, .basal_metabolic_rate, .time_in_daylight, .walking_steadiness, .running_ground_contact_time, .running_speed,
            .running_power, .running_stride_length, .running_vertical_oscillation, .six_minute_walk_test_distance, .stair_ascent_speed,
            .stair_descent_speed, .walking_asymmetry_percentage, .walking_double_support_percentage, .walking_speed, .walking_step_length:
            .activity
