...
extension SahhaSensor {
    ...
    private func generateSampleType() -> HKSampleType? {
        ...
        case .gender, .date_of_birth, .device_lock, .heart_rate_variability_rmssd, .total_energy_burned,
                .basal_metabolic_rate, .body_water_mass, .bone_mass, .exercise, .activity_summary:
            return nil
        @unknown default:
            return nil
        }
