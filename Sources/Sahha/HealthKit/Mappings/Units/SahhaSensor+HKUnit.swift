...
extension SahhaSensor {
    var hkUnit: HKUnit? {
        ...
        // Explicitly unsupported for quantity mapping
        case .gender, .date_of_birth, .device_lock, .exercise,
             .heart_rate_variability_rmssd, .activity_summary,
             .total_energy_burned, .basal_metabolic_rate,
             .body_water_mass, .bone_mass:
            return nil
        }
    }
}
